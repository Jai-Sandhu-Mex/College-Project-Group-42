...
const Bookcards = () => {
    var books;
    const { data, isPending, error } = useFetchFunction(`https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json?api-key=m9OZKl3eJ6pyqeGPv8eRruQPiAS0yVrz`);
